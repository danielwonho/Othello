...
public class MCNode {
	...
	/*
	 * bestChild if the next player to move in node is PLAYER1, it returns the
	 * child with the maximum average score, if the next player to move in the
	 * node is PLAYER2, then it returns the child with the minimum average
	 * score.
	 */
	...
	/*
	 * backup increments in 1 the number of times "node" has been visited, and
	 * updates the average score in "node" with the value "score". If "node" has
	 * a parent, then it calls "backup(node.parent,score)".
	 */
